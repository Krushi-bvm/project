...
import { addEmployee ,    removeEmployee,
    modifiedEmployee,
    changeStateTrue,
    changeStateFalse,fetchEmployee } from "../../feature/employSlice";
...
export default function About() {
  ...
  const updateEmployee = (item) => {
    ...
    setId(item.id);
    setName(item.name);
    setPosition(item.email);
    dispatch(changeStateTrue());
  };

  const updateForm = () => {
    dispatch(modifiedEmployee({ id: id, name: name, email: position }));
